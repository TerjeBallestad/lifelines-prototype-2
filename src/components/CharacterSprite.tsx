...
export const CharacterSprite = observer(function CharacterSprite({
  ...
  // Spring-animated position for smooth movement
  const springX = useSpring(character.position.x, {
    stiffness: 50,
    damping: 20,
  });
  const springY = useSpring(character.position.y, {
    stiffness: 50,
    damping: 20,
  });
  ...
  return (
    <motion.div className="absolute z-10" style={{ x: springX, y: springY }}>
      ...
      <AnimatePresence>
        ...
        {isPerforming && character.currentActivity && (
          ...
          >
            ...
            <div className="bg-base-100 min-w-24 rounded-2xl px-4 py-2 shadow-lg">
              {/* Activity icon and name */}
              <div className="mb-1 flex items-center justify-center gap-2">
                <span className="text-lg">
                  {character.currentActivity.icon ||
                    character.currentActivity.name.charAt(0)}
                </span>
